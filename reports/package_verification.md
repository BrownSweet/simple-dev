...
- Archive SHA256: `55d2ae0918aa9f0ee5e1f8ceb826344bdd29f60cd18462464130809a76b066c8`
- Failures: `0`
- Warnings: `0`
...
| Check | Status | Detail |
| --- | --- | --- |
| `package-manifest` | `pass` | Package manifest exists: /Users/brown/program/www/person-skill/simple-dev/reports/yao-package/manifest.json |
...
| `archive-entry-simple-dev/SKILL.md` | `pass` | Archive contains simple-dev/SKILL.md |
| `archive-entry-simple-dev/manifest.json` | `pass` | Archive contains simple-dev/manifest.json |
| `archive-entry-simple-dev/agents/interface.yaml` | `pass` | Archive contains simple-dev/agents/interface.yaml |
